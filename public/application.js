$(function() {
	...
	function github_api_url() {
		return "https://api.github.com/repos/" + github_user() + "/" + github_repo() + "/contents/recipes?access_token=51bfa46ab96268f721d05bcc9aae75090e84ef8e";
	}
			...
			$.each(response.data, function(index, elem) {
					$ul.append(
						"<li class='recipe'>" +
							...
							"<a class='source' href='"+ elem._links.self + "?access_token=51bfa46ab96268f721d05bcc9aae75090e84ef8e" + "'>View</a>" +
						"</li>"
					);
			});
		},
